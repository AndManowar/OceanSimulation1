...
{ 
[XmlInclude(typeof(SimpleFish)), XmlInclude(typeof(PredatoryFish)), XmlInclude(typeof(DeepFish))]
    public class BaseObject
    {
        ...
        public void Draw(SpriteBatch sprt)
        {
            if (IsRotate == true)
            {
                sprt.Draw(baseObject, BaseRectangle, null, Color.White, 0, new Vector2(0,0), SpriteEffects.FlipHorizontally, 0);
            }
            else if (isDead == true)
            {
                sprt.Draw(baseObject, BaseRectangle, null, Color.White, 0, new Vector2(0, 0), SpriteEffects.FlipVertically, 0);
            }
            else { sprt.Draw(baseObject, BaseRectangle, null, Color.White, 0, new Vector2(0, 0), SpriteEffects.None, 0); }
        }
    }
}